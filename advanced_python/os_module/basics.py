...
rmdir()                                                  ##                                          removes/deletes specified directory
remove()                                                 ##                                          removes file
...
path.isdir()                                             ##                                          return True if specified path is of a directory
path.basename()                                          ##                                          return filename
path.dirname()                                           ##                                          return directory name
'''